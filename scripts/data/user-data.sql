...
CALL CreateUser("john_doe", "john_doe_psw", "john.doe@qwe.com", 1, 1);
CALL CreateUser("alice_smith", "alice_smith_psw", "alice.smith@example.com", 1, 0);
CALL CreateUser("bob_jones", "bob_jones_psw", "bob.jones@bsuir.by", 1, 0);
CALL CreateUser("emma_wilson", "emma_wilson_psw", "emma.wilson@example.com", 1, 0);
CALL CreateUser("michael_brown", "michael_brown_psw", "michael.brown@example.com", 1, 0);
CALL CreateUser("olivia_davis", "olivia_davis_psw", "olivia.davis@example.com", 1, 0);
CALL CreateUser("william_miller", "william_miller_psw", "william.miller@inbox.ru", 1, 0);
CALL CreateUser("sophia_johnson", "sophia_johnson_psw", "sophia.johnson@mail.ru", 1, 0);
CALL CreateUser("james_anderson", "james_anderson_psw", "james.anderson@gmail.com", 1, 0);
CALL CreateUser("emily_clark", "emily_clark_psw", "emily.clark@gmail.com", 1, 0);
CALL CreateUser("danilaltd", "danilaltd_psw", "danilaltd@gmail.com", 1, 1);
...
VALUES
    ...
    (11, 'Daniil', 'BBBB', '2006-01-23');
    
-- Superusers
-- INSERT INTO user (username, password, email, is_admin) 
-- VALUES
-- 	('danilaltd', '10a6e6cc8311a3e2bcc09bf6c199adecd5dd59408c343e926b129c4914f3cb01', 'danilaltd@gmail.com', 1); # pass - test_password
